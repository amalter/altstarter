...
If you want to jump right in, take a look at the `altstarterPlugin\PostTypes\Demo::class` and `altstarterPlugin\Taxonomies\Demo::class` classes.
...
If you find yourself making the same changes across multiple classes or projects, please consider [opening a ticket](https://github.com/10up/altstarter/issues/new?assignees=&labels=type%3Aenhancement&projects=&template=2-enhancement.yml) which describes those changes.
