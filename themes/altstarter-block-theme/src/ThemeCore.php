...
class ThemeCore {
	...
	public function setup() {
		add_action( 'init', [ $this, 'init' ], apply_filters( 'altstarter_block_theme_init_priority', 8 ) );
		...
		do_action( 'altstarter_block_theme_loaded' );
	}
	...
	public function i18n() {
		load_theme_textdomain( 'altstarter-theme', ALTSTARTER_BLOCK_THEME_PATH . '/languages' );
	}
	...
	public function init() {
		do_action( 'altstarter_block_theme_before_init' );
		...
		ModuleInitialization::instance()->init_classes( ALTSTARTER_BLOCK_THEME_INC );
		do_action( 'altstarter_block_theme_init' );
	}
