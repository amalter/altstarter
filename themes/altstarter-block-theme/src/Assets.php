...
class Assets implements ModuleInterface {
	...
	public function scripts() {
		wp_enqueue_script(
			'frontend',
			ALTSTARTER_BLOCK_THEME_TEMPLATE_URL . '/dist/js/frontend.js',
	...
	public function styles() {
		wp_enqueue_style(
			'altstarter-theme-styles',
			ALTSTARTER_BLOCK_THEME_TEMPLATE_URL . '/dist/css/frontend.css',
			[],
			$this->get_asset_info( 'frontend', 'version' )
		);
	}
	...
	public function editor_style_overrides() {
		wp_enqueue_style(
			'altstarter-theme-editor-style-overrides',
			ALTSTARTER_BLOCK_THEME_TEMPLATE_URL . '/dist/css/editor-style-overrides.css',
			[],
			ALTSTARTER_BLOCK_THEME_VERSION
		);

		wp_enqueue_script(
			'altstarter-theme-block-extensions',
			ALTSTARTER_BLOCK_THEME_TEMPLATE_URL . '/dist/js/block-extensions.js',
	...
	public function register_all_icons() {
		...
		$icon_paths = glob( ALTSTARTER_BLOCK_THEME_DIST_PATH . 'svg/*.svg' );
